...
% This code has a little bit modification on "Jose Suau Rodriguez" code (isodata.m), 
% this one extend the classification dimension from 2D to N-D, and 
% runs faster (almost 50x times faster than isodata.m)
...
s=size(X);
s=s(1);
cluster=zeros(1,s); % Internal Temporary space function..
iter=0;
final=0;
vuelve3=0;
A=1;     % We initialize for the first case.
